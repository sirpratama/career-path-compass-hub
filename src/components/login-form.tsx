          ...
          <form className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-balance text-muted-foreground dark:text-gray-400">Login to your Career Compass account</p>
              </div>
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a href="#" className="ml-auto text-sm underline-offset-2 hover:underline dark:text-gray-400">
              ...
              <div className="text-center text-sm dark:text-gray-400">
                ...
                <a href="/signup" className="underline underline-offset-4 dark:text-primary">
                  Sign up
                </a>
              </div>
            </div>
