  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkMode ? "dark bg-gray-900 text-white" : ""}`}>
              ...
              <div className="relative">
                ...
                <ul className="relative flex space-x-6 items-center">
                  {navItems.map((item, index) => (
                    ...
                    >
                      <a href="#" className="text-sm whitespace-nowrap flex items-center justify-center h-full">
                        {item}
                      </a>
                    </li>
                  ))}
      ...
      <main className={`flex-grow ${isDarkMode ? "bg-gray-900" : ""}`}>
        {/* Hero Section */}
        <section className={`${isDarkMode ? "bg-gradient-to-br from-gray-900 to-purple-900" : "bg-gradient-to-br from-white to-career-light-purple"} py-16 md:py-24`}>
        ...
        <section className={`py-16 ${isDarkMode ? "bg-gray-800" : "bg-white"}`}>
          <div className="container mx-auto px-4 max-w-6xl">
            <h2 className={`text-3xl font-bold text-center mb-12 ${isDarkMode ? "text-white" : ""}`}>How It Works</h2>
            <div className="grid md:grid-cols-3 gap-10">
              <div className="text-center">
                <div className={`${isDarkMode ? "bg-purple-900" : "bg-career-light-purple"} w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4`}>
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    className={`h-8 w-8 ${isDarkMode ? "text-purple-400" : "text-career-purple"}`} 
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
                ...
                <h3 className={`text-xl font-semibold mb-2 ${isDarkMode ? "text-white" : ""}`}>Take the Quiz</h3>
              ...
              <div className="text-center">
                ...
                <h3 className={`text-xl font-semibold mb-2 ${isDarkMode ? "text-white" : ""}`}>Get Results</h3>
              ...
              <div className="text-center">
                ...
                <h3 className={`text-xl font-semibold mb-2 ${isDarkMode ? "text-white" : ""}`}>Explore Resources</h3>
